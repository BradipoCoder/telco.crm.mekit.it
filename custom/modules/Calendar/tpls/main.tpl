...
{sugar_getscript file="custom/modules/Calendar/js/CalModel.js"}
...
<link type="text/css" href="{sugar_getjspath file="modules/Calendar/fullcalendar/fullcalendar.print.css"}" media='print'
      rel="stylesheet"/>
...
{sugar_getscript file="custom/modules/Calendar/js/Cal.js"}
